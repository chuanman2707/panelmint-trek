...
export class JourneyMcp {
  ...
  @Tool({
    ...
    inputSchema: {
      ...
      type: ENTRY_TYPE.optional().describe('Defaults to "entry"; "skeleton" is the stub PanelMint derives from a trip place and hides behind the hide-skeletons preference'),
