 ...
 * client) keeps the standard PanelMint `{ error }` 404 envelope. The `@Catch(NotFoundException)`
...
export class SpaFallbackFilter implements ExceptionFilter {
    ...
    // Non-production, or a non-GET miss: keep the standard PanelMint 404 envelope
