...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bienvenido a PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de PanelMint',
  ...
  'system_notice.thank_you_support.title': 'Gracias por usar PanelMint',
  'system_notice.thank_you_support.body':
    'Un pequeño agradecimiento por instalar PanelMint — de verdad significa mucho para mí.\n\nSoy un desarrollador independiente y construyo PanelMint en mi tiempo libre. Empezó como una pequeña herramienta solo para mis propios viajes, y sinceramente me deja sin palabras todo el apoyo y el interés de la comunidad desde entonces. PanelMint está hecho con mucho cariño de mi parte — pero también gracias a los muchos colaboradores externos increíbles que han ayudado a darle forma.\n\n**PanelMint es open source y completamente gratuito — y seguirá siéndolo para siempre. Sin planes de pago, sin suscripciones, sin trampa. Te lo prometo.**\n\nSi PanelMint te resulta útil y quieres apoyar su desarrollo, un pequeño café me ayuda de verdad a seguir construyendo — sin ninguna presión, pero cada taza mantiene vivas las noches en vela.\n\nGracias por estar aquí.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'Cuatro cosas que PanelMint ahora hace por sí mismo.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'La alternativa autoalojada a Google Timeline, ahora legible desde PanelMint. PanelMint lee, y solo lee.',
  'system_notice.release_notes.footnote': 'Y una larga lista de cambios más pequeños en el resto de PanelMint.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint es gratis y siempre lo será, pero los servidores, los dominios y tantas noches en vela no lo son.',
