...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'De dónde vienen los datos de lugares. El índice de PanelMint no necesita clave; los dos proveedores de abajo son opcionales.',
  'admin.trekApi.badgeDefault': 'Fuente recomendada por defecto',
  'admin.googleCaveat.badge': 'No recomendado',
  'admin.googleCaveat.body':
    'PanelMint es software libre y aquí no somos neutrales. A esta escala, las valoraciones y las fotos de negocios corrientes solo existen en Google, y eso es un monopolio. El campo está aquí por falta de alternativa, no porque lo recomendemos. Cada consulta va entonces a Google.',
  'admin.trekApi.tagline':
    'El índice de lugares propio de PanelMint. Buscar sin clave de Google, sin cuota y sin que nadie cuente tus búsquedas.',
  ...
  'admin.mapsKeyHintLong':
    'Sin clave de API de Google se usa la API de PanelMint recomendada. Con una clave se pueden cargar además fotos, valoraciones y horarios. Créala en console.cloud.google.com.',
  ...
  'admin.placesProvider.subtitle': 'El índice propio de PanelMint y OpenStreetMap responden a cada búsqueda. Aquí se elige a quién más se consulta cuando no encuentran nada: Automático prefiere Google si hay clave, luego Amap.',
  'admin.placesProvider.auto': 'Automático',
  'admin.placesProvider.google': 'Google Places',
  'admin.placesProvider.amap': 'Amap (高德地图)',
  'admin.placesProvider.openstreetmap': 'OpenStreetMap',
  'admin.placesProvider.missingKey': 'El proveedor seleccionado no tiene clave de API configurada, así que la búsqueda de lugares la responden solo el índice de PanelMint y OpenStreetMap.',
  ...
  'admin.plugins.requiresTrek': 'Requiere PanelMint {version}+',
  ...
  'admin.plugins.perm.hook:search-provider':
    'Responder a búsquedas de lugares desde su propio índice, junto a los resultados de PanelMint',
  ...
  'admin.plugins.perm.geolocation:read':
    'Consultar tu ubicación en tiempo real mientras una de sus vistas esté abierta (PanelMint la lee con el permiso de ubicación de este sitio, no con uno propio del plugin)',
  ...
  'admin.plugins.reviewedMeaning':
    '"Revisado" significa que un responsable de PanelMint analizó este plugin en busca de malware en cada versión, no su calidad ni si funciona. No es una garantía de que un plugin sea inofensivo.',
  ...
  'admin.plugins.sig.missingBody':
    'Este plugin estaba firmado cuando lo instalaste, pero la nueva versión no incluye ninguna firma. PanelMint no aceptará esa degradación en silencio. Esto no se puede omitir.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'PanelMint no puede distinguir una rotación de clave legítima de un secuestro — desde aquí ambas se ven idénticas. Confirma la nueva clave con el autor por un canal en el que ya confíes antes de aceptarla. Cuando lo hagas, el plugin se actualizará y la nueva clave quedará registrada.',
  ...
  'admin.plugins.security.trustBody':
    'Instalar un plugin es como instalar cualquier aplicación de terceros: añade únicamente código de autores en los que confíes y, en caso de duda, inspecciónalo tú mismo primero. PanelMint no asume ninguna responsabilidad por los plugins de terceros.',
  ...
  'admin.plugins.newerNeedsTrek': 'v{version} disponible — necesita PanelMint {range}',
  ...
  'admin.plugins.versionNeedsTrek': 'necesita PanelMint {range}',
  ...
  'admin.plugins.dep.trekIncompatible': 'Necesita PanelMint {range} — este servidor ejecuta {host}',
  'admin.plugins.dep.trekUnknown': 'No indica qué versiones de PanelMint admite',
  ...
  'admin.plugins.rangeBypass.title': 'Fuera de las versiones de PanelMint compatibles',
  'admin.plugins.rangeBypass.noticeTitle': 'Instalado fuera de las versiones de PanelMint compatibles',
  ...
  'admin.plugins.dep.trekBypassed':
    'Fuera de su rango de PanelMint ({range}) — comprobaciones de versión desactivadas',
  'admin.plugins.dep.trekBypassedUnknown':
    'No declara ningún rango de PanelMint — comprobaciones de versión desactivadas',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en PanelMint.',
  ...
  'admin.weather.description':
    'PanelMint utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.update.text': 'PanelMint {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText':
    'PanelMint se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText':
    'Tu instancia de PanelMint se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  'admin.update.nonDockerText':
    'Esta instancia de PanelMint no se ejecuta en Docker. Para actualizar a {version}, vuelve a ejecutar el método de instalación o actualización que utilizaste; por ejemplo, en Proxmox Community Scripts ejecuta la actualización desde la consola LXC:',
