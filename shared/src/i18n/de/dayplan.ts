...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFileTooltip': 'Lade den Trip als .panelmint.json-Datei herunter',
  'dayplan.exportFileDone': 'Trip-Datei heruntergeladen',
  'dayplan.exportFileError': 'Die Trip-Datei konnte nicht exportiert werden',
