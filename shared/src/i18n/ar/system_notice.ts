...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_thankyou.body':
    'قبل أن تمضي — أريد أن أتوقف لحظة.\n\nبدأ PanelMint كمشروع جانبي بنيته لرحلاتي الخاصة. لم أتخيل يومًا أنه سيكبر ليصبح شيئًا يعتمد عليه 4,000 منكم لتخطيط مغامراتهم. كل نجمة، كل مشكلة، كل طلب ميزة — أقرأها جميعًا، وهي ما يبقيني مستمرًا في الليالي المتأخرة بين عمل بدوام كامل والجامعة.\n\nأريدكم أن تعرفوا: PanelMint سيبقى دائمًا مفتوح المصدر، دائمًا مستضافًا ذاتيًا، دائمًا ملككم. لا تتبع، لا اشتراكات، لا شروط خفية. مجرد أداة بناها شخص يحب السفر بقدر ما تحبونه.\n\nشكر خاص لـ [jubnl](https://github.com/jubnl) — لقد أصبحت متعاونًا رائعًا. الكثير مما يجعل الإصدار 3.0 عظيمًا يحمل بصماتك. شكرًا لإيمانك بهذا المشروع عندما كان لا يزال في بداياته.\n\nولكل واحد منكم ممن أبلغ عن خطأ، أو ترجم نصًا، أو شارك PanelMint مع صديق، أو ببساطة استخدمه لتخطيط رحلة — **شكرًا لكم**. أنتم السبب في وجود هذا.\n\nإلى المزيد من المغامرات معًا.\n\n— Maurice\n\n---\n\n[انضم إلى المجتمع على Discord](https://discord.gg/7Q6M6jDwzf)\n\nإذا جعل PanelMint رحلاتك أفضل، [فنجان قهوة صغير](https://ko-fi.com/mauriceboe) يبقي الأضواء مشتعلة.',
  ...
  'system_notice.welcome_v1.title': 'مرحبًا بك في PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'وجهة سفر خلابة مع واجهة تطبيق PanelMint',
  ...
  'system_notice.thank_you_support.title': 'شكرًا لاستخدامك PanelMint',
  'system_notice.thank_you_support.body':
    'شكرًا سريعًا على تثبيتك PanelMint — هذا يعني لي الكثير حقًا.\n\nأنا مطوّر منفرد أبني PanelMint في وقت فراغي. بدأ كأداة صغيرة لرحلاتي الخاصة فحسب، وصدقًا أنا مندهش من الدعم والاهتمام اللذين أبداهما المجتمع منذ ذلك الحين. PanelMint مصنوع بكثير من الحب من جانبي — ولكن أيضًا بفضل العديد من المساهمين الخارجيين الرائعين الذين ساعدوا في تشكيله.\n\n**PanelMint مفتوح المصدر ومجاني تمامًا — وسيبقى كذلك إلى الأبد. لا باقات مدفوعة، لا اشتراكات، لا شروط خفية. أعدكم بذلك.**\n\nإذا كان PanelMint مفيدًا لك وأردت دعم تطويره، فإن فنجان قهوة صغيرًا يساعدني حقًا على مواصلة البناء — لا ضغط على الإطلاق، لكن كل فنجان يبقي الليالي المتأخرة مستمرة.\n\nشكرًا لوجودك هنا.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'أربعة أشياء يقوم بها PanelMint الآن بنفسه.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'البديل المستضاف ذاتيًا لـ Google Timeline، وصار بالإمكان الآن قراءته داخل PanelMint. يقرأ PanelMint، ويقرأ فقط.',
  'system_notice.release_notes.footnote': 'إلى جانب قائمة طويلة من التغييرات الأصغر في بقية أرجاء PanelMint.',
  'system_notice.release_notes.notes_label': 'ملاحظات الإصدار',
  'system_notice.release_notes.note_eyebrow': 'كلمة من صاحب المشروع',
  'system_notice.release_notes.note_title': 'أنتم السبب في أنني ما زلت أبني PanelMint.',
  'system_notice.release_notes.note_body':
    'بدأ PanelMint كأداة صغيرة لرحلاتي الخاصة، كتبتها بعد العمل لأنني أردت طريقة أفضل لتخطيطها. ومنذ ذلك الحين لم يتوقف عن النمو. كل ما تستخدمه تقريبًا بُني في ساعات متأخرة من الليل، وفي عطل نهاية الأسبوع، وفي القطارات، إلى جانب عمل بدوام كامل، وكم من أمسية تساءلت فيها بيني وبين نفسي: هل سيفتحه أحد يومًا؟',
  'system_notice.release_notes.promise_label': 'الوعد',
  'system_notice.release_notes.promise_lead': 'سيبقى PanelMint مجانيًا، إلى الأبد.',
  ...
  'system_notice.release_notes.support_lead':
    'صحيح أن PanelMint مجاني وسيبقى كذلك دائمًا، لكن الخوادم والنطاقات والكثير من الليالي المتأخرة ليست مجانية.',
  'system_notice.release_notes.support_text':
    'إن كان PanelMint قد استحق مكانًا في رحلاتك، فاشترِ لي فنجان قهوة وساعد في أن يرى الإصدار القادم النور.',
