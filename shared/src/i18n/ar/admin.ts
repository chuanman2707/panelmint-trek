...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'من أين تأتي بيانات الأماكن. فهرس PanelMint لا يحتاج مفتاحًا؛ والمزوّدان أدناه اختياريان.',
  'admin.trekApi.badgeDefault': 'الافتراضي الموصى به',
  'admin.googleCaveat.badge': 'غير مُستحسَن',
  'admin.googleCaveat.body':
    'PanelMint مفتوح المصدر ولسنا محايدين هنا. بهذا الحجم لا توجد التقييمات وصور المحال العادية إلا لدى Google، وهذا هو الاحتكار. الحقل موجود لانعدام البديل، لا لأننا نوصي به. عندئذ يذهب كل استعلام إلى Google.',
  'admin.trekApi.tagline':
    'فهرس الأماكن الخاص بـ PanelMint. بحث بلا مفتاح من Google، بلا حصة، وبلا أن يُحصي أحد عمليات بحثك.',
  ...
  'admin.placesProvider.subtitle':
    'يجيب فهرس PanelMint الخاص وOpenStreetMap عن كل بحث. هنا يُختار من يُسأل أيضاً عندما لا يجدان شيئاً: «تلقائي» يفضّل Google عند وجود مفتاح، ثم Amap.',
  'admin.placesProvider.auto': 'تلقائي',
  'admin.placesProvider.google': 'Google Places',
  'admin.placesProvider.amap': 'Amap (高德地图)',
  'admin.placesProvider.openstreetmap': 'OpenStreetMap',
  'admin.placesProvider.missingKey': 'لا يوجد مفتاح API للمزوّد المختار، لذا يجيب عن البحث عن الأماكن فهرس PanelMint وOpenStreetMap وحدهما.',
  ...
  'admin.plugins.requiresTrek': 'يتطلب PanelMint {version}+',
  ...
  'admin.plugins.perm.hook:search-provider': 'الإجابة على عمليات البحث عن الأماكن من فهرس خاص به، إلى جانب نتائج PanelMint',
  ...
  'admin.plugins.perm.geolocation:read':
    'الاستعلام عن موقعك المباشر ما دامت إحدى واجهاته مفتوحة (يقرأه PanelMint بإذن الموقع الممنوح لهذا الموقع الإلكتروني، لا بإذن خاص بالإضافة)',
  ...
  'admin.plugins.reviewedMeaning':
    '"تمت مراجعتها" تعني أن أحد القائمين على PanelMint فحص هذه الإضافة بحثًا عن البرمجيات الخبيثة في كل إصدار — وليس من حيث الجودة أو ما إذا كانت تعمل. وهي ليست ضمانًا بأن الإضافة غير ضارة.',
  ...
  'admin.plugins.security.reviewedBody':
    'الإضافة التي تمت مراجعتها فُحصت يدويًا بحثًا عن البرمجيات الخبيثة بواسطة أحد القائمين على PanelMint في كل إصدار — جرى فحصها بحثًا عن شيفرة ضارة، لا لمعرفة ما إذا كانت تعمل جيدًا. وهي ليست وعدًا بأن الإضافة غير ضارة.',
  'admin.plugins.security.signedTitle': 'ماذا تعني "موقّعة"',
  'admin.plugins.security.signedBody':
    'المجموع الاختباري الذي يتحقق منه PanelMint عند كل تثبيت يثبت أن الملفات هي بالضبط ما يضمنه السجل. أما التوقيع فيثبت شيئًا مختلفًا: أنها جاءت من المؤلف، موقّعة بمفتاح لا يملكه سواه. الإضافة الموقّعة تجمع الاثنين معًا. وغير الموقّعة ليست غير آمنة — إنها ببساطة تحمل ضمانًا واحدًا أقل، ومعظم الإضافات في السجل غير موقّعة اليوم.',
  ...
  'admin.plugins.sig.missingBody':
    'كانت هذه الإضافة موقّعة عند تثبيتها، لكن الإصدار الجديد لا يحمل أي توقيع. لن يقبل PanelMint هذا التراجع بصمت. لا يمكن تجاوز ذلك.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'لا يستطيع PanelMint التمييز بين تبديل مشروع للمفتاح وبين استيلاء على الإضافة — يبدو الأمران متطابقين من هنا. تحقّق من المفتاح الجديد مع المؤلف عبر قناة تثق بها أصلًا قبل قبوله. وحين تفعل، يتم تحديث الإضافة ويُحفظ المفتاح الجديد.',
  ...
  'admin.plugins.security.trustBody':
    'تثبيت إضافة يشبه تثبيت أي تطبيق من جهة خارجية: لا تُضِف سوى شيفرة من مطورين تثق بهم، وعند الشك، افحصها بنفسك أولًا. لا يتحمل PanelMint أي مسؤولية عن إضافات الجهات الخارجية.',
  ...
  'admin.plugins.newerNeedsTrek': 'الإصدار v{version} متوفر — يتطلب PanelMint {range}',
  ...
  'admin.plugins.versionNeedsTrek': 'يتطلب PanelMint {range}',
  ...
  'admin.plugins.dep.trekIncompatible': 'يتطلب PanelMint {range} — يعمل هذا الخادم بالإصدار {host}',
  'admin.plugins.dep.trekUnknown': 'لا يحدد إصدارات PanelMint المدعومة',
  ...
  'admin.plugins.rangeBypass.title': 'خارج إصدارات PanelMint المدعومة',
  'admin.plugins.rangeBypass.noticeTitle': 'تم التثبيت خارج إصدارات PanelMint المدعومة',
  ...
  'admin.plugins.dep.trekBypassed': 'خارج نطاق PanelMint الخاص بها ({range}) — فحوصات الإصدار متوقفة',
  'admin.plugins.dep.trekBypassedUnknown': 'لا تعلن أي نطاق PanelMint — فحوصات الإصدار متوقفة',
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة PanelMint.',
  ...
  'admin.weather.description':
    'يستخدم PanelMint خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.update.text': 'PanelMint {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث PanelMint من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل PanelMint الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  'admin.update.nonDockerText':
    'لا يعمل PanelMint هذا في Docker. للتحديث إلى {version}، أعد تشغيل طريقة التثبيت أو التحديث التي استخدمتها — على سبيل المثال، في Proxmox Community Scripts نفّذ التحديث من وحدة تحكم LXC:',
