...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Benvingut/da a PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destí de viatge pintoresc amb la interfície de PanelMint',
  ...
  'system_notice.v3_photos.body':
    "Les **Fotos** al Planificador de Viatges han estat eliminades. Les teves fotos estan segures — PanelMint mai va modificar la teva biblioteca d'Immich o Synology.\n\nLes fotos ara viuen al complement **Journey**. Journey és opcional — si encara no està disponible, demana al teu admin que l'activi a Admin → Complementos.",
  ...
  'system_notice.thank_you_support.title': 'Gràcies per utilitzar PanelMint',
  'system_notice.thank_you_support.body':
    "Si t'agrada utilitzar PanelMint, considera donar suport al seu desenvolupament de codi obert.",
  ...
  'system_notice.release_notes.headline': 'Quatre coses que PanelMint ara fa tot sol.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'L’alternativa autoallotjada a Google Timeline, ara llegible des de PanelMint. PanelMint llegeix, i només llegeix.',
  'system_notice.release_notes.footnote': 'I una llarga llista de canvis més petits a la resta de PanelMint.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint és gratuït i ho serà sempre, però els servidors, els dominis i tantes nits llargues no ho són.',
