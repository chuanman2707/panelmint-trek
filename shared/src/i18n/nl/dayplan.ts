...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFileTooltip': 'Download de reis als .panelmint.json-bestand',
  'dayplan.exportFileDone': 'Reisbestand gedownload',
  'dayplan.exportFileError': 'Het reisbestand kon niet worden geëxporteerd',
