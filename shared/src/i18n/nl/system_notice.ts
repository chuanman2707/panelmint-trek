...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Welkom bij PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met PanelMint interface',
  ...
  'system_notice.thank_you_support.title': 'Bedankt voor het gebruik van PanelMint',
  'system_notice.thank_you_support.body':
    'Even een kort bedankje dat je PanelMint hebt geïnstalleerd — het betekent echt veel voor me.\n\nIk ben een solo-ontwikkelaar en bouw PanelMint in mijn vrije tijd. Het begon als een klein hulpmiddel voor mijn eigen reizen, en ik ben oprecht overweldigd door de steun en de interesse vanuit de community sindsdien. PanelMint is met heel veel hart gemaakt aan mijn kant — maar ook dankzij de vele geweldige externe bijdragers die hebben geholpen het vorm te geven.\n\n**PanelMint is open source en volledig gratis — en dat zal het voor altijd blijven. Geen betaalde versies, geen abonnementen, geen addertjes onder het gras. Dat beloof ik.**\n\nAls PanelMint nuttig voor je is en je de ontwikkeling ervan wilt steunen, helpt een klein kopje koffie me oprecht om te blijven bouwen — absoluut geen druk, maar elk kopje houdt de late avonden gaande.\n\nBedankt dat je er bent.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'Vier dingen die PanelMint nu zelf doet.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Het zelfgehoste antwoord op Google Timeline, nu rechtstreeks leesbaar in PanelMint. PanelMint leest, en alleen dat.',
  'system_notice.release_notes.footnote': 'En daarnaast een lange lijst kleinere wijzigingen in de rest van PanelMint.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint is gratis en blijft dat ook, maar servers, domeinen en heel wat late avonden zijn dat niet.',
  'system_notice.release_notes.support_text':
    'Als PanelMint een plek in je reizen heeft verdiend, trakteer me dan op een kopje koffie en help zo de volgende release op weg.',
