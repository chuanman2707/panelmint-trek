...
const vacay: TranslationStrings = {
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere PanelMint-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van PanelMint-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere PanelMint-gebruiker uit om een gecombineerde vakantiekalender te delen.',
  ...
  'vacay.shareCalendarHint':
    'Laat een andere PanelMint-gebruiker je vakantiekalender zien. Alleen bekijken — geen fusie, geen bewerking.',
