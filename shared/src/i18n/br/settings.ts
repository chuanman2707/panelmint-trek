...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Enquanto você planeja sua próxima rota, essas pessoas planejam junto o futuro do PanelMint. A contribuição mensal delas vai direto para o desenvolvimento e horas reais investidas — para o PanelMint continuar Open Source.',
  ...
  'settings.airtrail.writeBackHint':
    'Desativado por padrão: o AirTrail é a fonte da verdade e o PanelMint apenas lê dele. Ative para enviar ao AirTrail as alterações feitas no PanelMint.',
