...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do PanelMint',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário PanelMint',
  ...
  'vacay.inviteHint': 'Convide outro usuário PanelMint para compartilhar um calendário de férias combinado.',
  ...
  'vacay.shareCalendarHint':
    'Permita que outro usuário PanelMint veja seu calendário de férias. Somente visualização — sem fusão, sem edição.',
