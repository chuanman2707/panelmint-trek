...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFileTooltip': 'Pobierz podróż jako plik .panelmint.json',
  'dayplan.exportFileDone': 'Plik podróży pobrany',
  'dayplan.exportFileError': 'Nie udało się wyeksportować pliku podróży',
