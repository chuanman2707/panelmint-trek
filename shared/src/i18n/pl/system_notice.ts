...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Witaj w PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malownicze miejsce z interfejsem planowania PanelMint',
  ...
  'system_notice.thank_you_support.title': 'Dziękuję, że korzystasz z PanelMint',
  'system_notice.thank_you_support.body':
    'Krótkie podziękowanie za zainstalowanie PanelMint — naprawdę wiele dla mnie znaczy.\n\nJestem samodzielnym programistą i tworzę PanelMint po godzinach. Wszystko zaczęło się jako małe narzędzie tylko na moje własne podróże, a wsparcie i zainteresowanie ze strony społeczności od tamtej pory szczerze mnie powaliły. PanelMint powstaje z wielkim sercem z mojej strony — ale także dzięki wielu wspaniałym zewnętrznym współtwórcom, którzy pomogli go ukształtować.\n\n**PanelMint jest open source i całkowicie darmowy — i tak już zostanie na zawsze. Bez płatnych wersji, bez subskrypcji, bez haczyków. Obiecuję.**\n\nJeśli PanelMint jest dla Ciebie przydatny i chciałbyś wesprzeć jego rozwój, mała kawa naprawdę pomaga mi tworzyć dalej — bez żadnej presji, ale każda filiżanka pozwala przetrwać kolejne nocne sesje przy kodzie.\n\nDziękuję, że tu jesteś.\n\n— Maurice',
  ...
  'system_notice.v3_thankyou.body':
    'Zanim pójdziesz dalej — chcę się na chwilę zatrzymać.\n\nPanelMint zaczął się jako poboczny projekt, który zbudowałem na własne podróże. Nigdy nie wyobrażałem sobie, że wyrośnie na coś, czemu 4000 z was ufa przy planowaniu swoich przygód. Każda gwiazdka, każdy issue, każda prośba o funkcję — czytam je wszystkie i to one trzymają mnie na nogach podczas późnych nocy między pracą na pełny etat a uczelnią.\n\nChcę, żebyście wiedzieli: PanelMint zawsze będzie open source, zawsze self-hosted, zawsze wasz. Bez śledzenia, bez subskrypcji, bez haczyków. Po prostu narzędzie zbudowane przez kogoś, kto kocha podróżowanie tak samo jak wy.\n\nSzczególne podziękowania dla [jubnl](https://github.com/jubnl) — stałeś się niesamowitym współpracownikiem. Tak wiele z tego, co czyni wersję 3.0 wspaniałą, nosi twój ślad. Dziękuję, że uwierzyłeś w ten projekt, gdy był jeszcze surowy.\n\nI każdemu z was, kto zgłosił błąd, przetłumaczył tekst, podzielił się PanelMint z przyjacielem lub po prostu użył go do zaplanowania podróży — **dziękuję**. To wy jesteście powodem, dla którego to istnieje.\n\nZa wiele kolejnych wspólnych przygód.\n\n— Maurice\n\n---\n\n[Dołącz do społeczności na Discordzie](https://discord.gg/7Q6M6jDwzf)\n\nJeśli PanelMint sprawia, że Twoje podróże są lepsze, [mała kawa](https://ko-fi.com/mauriceboe) zawsze pomaga utrzymać światła włączone.',
  ...
  'system_notice.release_notes.headline': 'Cztery rzeczy, które PanelMint robi teraz sam.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Samodzielnie hostowana odpowiedź na Google Timeline, teraz dostępna w PanelMint. PanelMint tylko odczytuje, nic więcej.',
  'system_notice.release_notes.footnote': 'Do tego długa lista mniejszych zmian w całej reszcie PanelMint.',
  'system_notice.release_notes.notes_label': 'Notatki do wydania',
  'system_notice.release_notes.note_eyebrow': 'Słowo od autora',
  'system_notice.release_notes.note_title': 'To dzięki wam wciąż rozwijam PanelMint.',
  'system_notice.release_notes.note_body':
    'PanelMint zaczął się jako małe narzędzie na moje własne podróże, pisane po pracy, bo chciałem wygodniej je planować. I tak naprawdę nigdy nie przestał rosnąć. Prawie wszystko, z czego korzystacie, powstało późno w nocy, w weekendy, w pociągach, obok pracy na pełny etat, i było wiele wieczorów, kiedy po cichu zastanawiałem się, czy ktokolwiek go kiedyś otworzy.',
  'system_notice.release_notes.promise_label': 'Obietnica',
  'system_notice.release_notes.promise_lead': 'PanelMint pozostanie darmowy, na zawsze.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint jest darmowy i zawsze taki będzie, ale serwery, domeny i wiele zarwanych nocy już nie.',
  'system_notice.release_notes.support_text':
    'Jeśli PanelMint zasłużył na miejsce w Twoich podróżach, postaw mi kawę i pomóż, żeby powstało kolejne wydanie.',
