...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами PanelMint',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача PanelMint',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача PanelMint для спільного календаря відпусток.',
  ...
  'vacay.shareCalendarHint':
    'Дозвольте іншому користувачу PanelMint бачити ваш календар відпусток. Лише перегляд — без об’єднання та редагування.',
