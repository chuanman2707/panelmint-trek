...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Ласкаво просимо в PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописне місце призначення з інтерфейсом PanelMint',
  ...
  'system_notice.thank_you_support.title': 'Дякую, що користуєтесь PanelMint',
  'system_notice.thank_you_support.body':
    'Невелика подяка за те, що встановили PanelMint — для мене це справді багато значить.\n\nЯ розробник-одинак і створюю PanelMint у вільний час. Усе почалося як маленький інструмент для моїх власних поїздок, і відтоді я щиро вражений підтримкою та інтересом спільноти. PanelMint зроблено з великою любов’ю з мого боку — але також завдяки багатьом чудовим зовнішнім контриб’юторам, які допомогли його сформувати.\n\n**PanelMint має відкритий код і повністю безкоштовний — і таким залишиться назавжди. Жодних платних тарифів, жодних підписок, жодних підводних каменів. Обіцяю.**\n\nЯкщо PanelMint корисний для вас і ви хочете підтримати його розробку, невелика кава справді допомагає мені продовжувати — жодного тиску, але кожна чашка підтримує ці пізні ночі.\n\nДякую, що ви тут.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'Чотири речі, які PanelMint тепер робить сам.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Self-hosted альтернатива Google Timeline, яку тепер можна читати прямо в PanelMint. PanelMint читає, і тільки читає.',
  'system_notice.release_notes.footnote': 'А також довгий список дрібніших змін по всьому PanelMint.',
  'system_notice.release_notes.notes_label': 'Нотатки до релізу',
  'system_notice.release_notes.note_eyebrow': 'Слово від мейнтейнера',
  'system_notice.release_notes.note_title': 'Саме заради вас я далі розвиваю PanelMint.',
  ...
  'system_notice.release_notes.promise_lead': 'PanelMint залишиться безкоштовним назавжди.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint безкоштовний і таким залишиться, а от сервери, домени й безліч пізніх ночей ні.',
  'system_notice.release_notes.support_text':
    'Якщо PanelMint заслужив місце у ваших подорожах, пригостіть мене кавою і допоможіть наблизити наступний реліз.',
