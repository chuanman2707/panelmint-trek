...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFileTooltip': 'Завантажити подорож файлом .panelmint.json',
  'dayplan.exportFileDone': 'Файл подорожі завантажено',
  'dayplan.exportFileError': 'Не вдалося експортувати файл подорожі',
