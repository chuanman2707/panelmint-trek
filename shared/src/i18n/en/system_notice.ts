...
const system_notice: TranslationStrings = {
  ...
  'system_notice.welcome_v1.title': 'Welcome to PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with PanelMint planning UI overlay',
  ...
  'system_notice.thank_you_support.title': 'Thank you for using PanelMint',
  'system_notice.thank_you_support.body':
    "A quick thank-you for installing PanelMint — it genuinely means a lot.\n\nI'm a solo developer and I build PanelMint in my spare time. It started as a little tool just for my own trips, and I'm honestly blown away by the support and interest from the community since then. PanelMint is made with a lot of heart on my side — but also thanks to the many amazing external contributors who've helped shape it.\n\n**PanelMint is open source and completely free — and it will stay that way forever. No paid tiers, no subscriptions, no catch. I promise.**\n\nIf PanelMint is useful to you and you'd like to support its development, a small coffee genuinely helps me keep building — no pressure at all, but every cup keeps the late nights going.\n\nThank you for being here.\n\n— Maurice",
  ...
  'system_notice.release_notes.headline': 'Four things PanelMint now does on its own.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'The self-hosted answer to Google Timeline, now readable inside PanelMint. PanelMint reads, and only reads.',
  'system_notice.release_notes.footnote': 'Plus a long list of smaller changes across the rest of PanelMint.',
  'system_notice.release_notes.notes_label': 'Release notes',
  'system_notice.release_notes.note_eyebrow': 'A note from the maintainer',
  'system_notice.release_notes.note_title': 'You are the reason I keep building PanelMint.',
  'system_notice.release_notes.note_body':
    'PanelMint began as a small tool for my own trips, written after work because I wanted a better way to plan them. It never really stopped growing. Almost everything you use was built late at night, on weekends, on trains, next to a full-time job, and there were plenty of evenings I quietly wondered whether anyone out there would ever open it.',
  'system_notice.release_notes.promise_label': 'The promise',
  'system_notice.release_notes.promise_lead': 'PanelMint stays free, forever.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint is free and always will be, but servers, domains and a lot of late nights are not.',
