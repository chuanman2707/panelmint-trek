...
const en: NotificationLocale = {
  email: {
    footer: 'You received this because you have notifications enabled in PanelMint.',
    manage: 'Manage preferences in Settings',
    madeWith: 'Made with',
    openTrek: 'Open PanelMint',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} invited you to fuse vacation plans. Open PanelMint to accept or decline.`,
    }),
    vacay_share: (p) => ({
      title: 'Vacay Calendar Shared',
      body: `${p.actor} shared their vacation calendar with you. Open PanelMint to view it.`,
    }),
    collection_invite: (p) => ({
      title: 'Collection invite',
      body: `${p.actor} invited you to share a collection. Open PanelMint to accept or decline.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'New PanelMint version available',
      body: `PanelMint ${p.version} is now available. Visit the admin panel to update.`,
    }),
    replica_failure: (p) => ({
  ...
  passwordReset: {
    ...
    greeting: 'Hi',
    body: 'We received a request to reset the password for your PanelMint account. Click the button below to set a new password.',
