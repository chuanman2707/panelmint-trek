...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Добро пожаловать в PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом PanelMint',
  ...
  'system_notice.thank_you_support.title': 'Спасибо, что выбрали PanelMint',
  'system_notice.thank_you_support.body':
    'Небольшое спасибо за то, что установили PanelMint — для меня это правда очень много значит.\n\nЯ разработчик-одиночка и делаю PanelMint в свободное время. Всё началось как маленький инструмент для моих собственных поездок, и я, честно говоря, поражён той поддержкой и интересом, которые проявило сообщество с тех пор. PanelMint создаётся с большой любовью с моей стороны — но также благодаря множеству замечательных внешних участников, которые помогли его сформировать.\n\n**PanelMint — это открытый исходный код и полностью бесплатно — и так будет всегда. Никаких платных тарифов, никаких подписок, никаких подвохов. Обещаю.**\n\nЕсли PanelMint вам полезен и вы хотите поддержать его развитие, маленький кофе по-настоящему помогает мне продолжать — без всякого давления, но каждая чашка даёт силы для поздних ночей.\n\nСпасибо, что вы здесь.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'Четыре вещи, которые PanelMint теперь делает сам.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Альтернатива Google Timeline на вашем собственном сервере, и теперь её данные видны прямо в PanelMint. PanelMint читает, и только читает.',
  'system_notice.release_notes.footnote': 'Плюс длинный список небольших изменений во всём остальном PanelMint.',
  'system_notice.release_notes.notes_label': 'Заметки к релизу',
  'system_notice.release_notes.note_eyebrow': 'Слово от мейнтейнера',
  'system_notice.release_notes.note_title': 'Именно ради вас я продолжаю развивать PanelMint.',
  'system_notice.release_notes.note_body':
    'PanelMint начинался как маленький инструмент для моих собственных поездок: я писал его после работы, потому что хотел планировать их удобнее. С тех пор он, по сути, так и не перестал расти. Почти всё, чем вы пользуетесь, создано поздно ночью, по выходным, в поездах, параллельно с основной работой, и было немало вечеров, когда я тихо сомневался, откроет ли его вообще хоть кто-нибудь.',
  'system_notice.release_notes.promise_label': 'Обещание',
  'system_notice.release_notes.promise_lead': 'PanelMint остаётся бесплатным навсегда.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint бесплатен и таким останется, а вот серверы, домены и бесконечные поздние вечера бесплатными не бывают.',
  'system_notice.release_notes.support_text':
    'Если PanelMint заслужил место в ваших поездках, угостите меня кофе и помогите выпустить следующий релиз.',
