...
const trip: TranslationStrings = {
  ...
  'trip.invite.linkHint':
    'Любой пользователь с аккаунтом PanelMint, открыв эту ссылку, присоединится к поездке как участник. Создайте ссылку заново, чтобы старая перестала работать.',
