...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'Откуда берутся данные о местах. Указателю PanelMint ключ не нужен; два поставщика ниже необязательны.',
  'admin.trekApi.badgeDefault': 'Рекомендуемый источник',
  'admin.googleCaveat.badge': 'Не рекомендуется',
  'admin.googleCaveat.body':
    'PanelMint с открытым исходным кодом, и мы здесь не нейтральны. В таком масштабе отзывы и фотографии обычных заведений есть только у Google, и это и есть монополия. Поле здесь из-за отсутствия альтернативы, а не потому, что мы его советуем. Тогда каждый запрос уходит в Google.',
  'admin.trekApi.tagline':
    'Собственный указатель мест PanelMint. Поиск без ключа Google, без квоты и без того, чтобы кто-то считал ваши запросы.',
  ...
  'admin.placesProvider.subtitle':
    'Собственный индекс PanelMint и OpenStreetMap отвечают на каждый поиск. Здесь выбирается, кого спросить дополнительно, если они ничего не нашли: «Автоматически» предпочитает Google при наличии ключа, затем Amap.',
  'admin.placesProvider.auto': 'Автоматически',
  'admin.placesProvider.google': 'Google Places',
  'admin.placesProvider.amap': 'Amap (高德地图)',
  'admin.placesProvider.openstreetmap': 'OpenStreetMap',
  'admin.placesProvider.missingKey': 'Для выбранного поставщика не задан ключ API, поэтому на поиск мест отвечают только индекс PanelMint и OpenStreetMap.',
  ...
  'admin.plugins.requiresTrek': 'Требуется PanelMint {version}+',
  ...
  'admin.plugins.perm.hook:search-provider':
    'Отвечать на поиск мест из собственного индекса, рядом с результатами PanelMint',
  ...
  'admin.plugins.perm.geolocation:read':
    'Запрашивать ваше местоположение в реальном времени, пока открыто одно из его представлений (PanelMint читает его с разрешением на геолокацию для этого сайта, а не с отдельным разрешением плагина)',
  ...
  'admin.plugins.reviewedMeaning':
    '«Проверен» означает, что сопровождающий PanelMint проверял этот плагин на вредоносный код в каждой версии — но не его качество или работоспособность. Это не гарантия того, что плагин безвреден.',
  ...
  'admin.plugins.security.reviewedBody':
    'Проверенный плагин был вручную просканирован на вредоносный код сопровождающим PanelMint в каждой версии — проверен на вредоносный код, а не на то, насколько хорошо он работает. Это не обещание того, что плагин безвреден.',
  'admin.plugins.security.signedTitle': 'Что означает «Подписан»',
  'admin.plugins.security.signedBody':
    'Контрольная сумма, которую PanelMint проверяет при каждой установке, доказывает, что файлы — ровно те, за которые ручается реестр. Подпись доказывает другое: что они пришли от автора и подписаны ключом, который есть только у него. У подписанного плагина есть и то, и другое. Неподписанный плагин не является небезопасным — просто у него одной гарантией меньше, и большинство плагинов в реестре сегодня не подписаны.',
  ...
  'admin.plugins.sig.missingBody':
    'Этот плагин был подписан, когда вы его устанавливали, но новая версия поставляется без подписи. PanelMint не примет такой откат молча. Это нельзя обойти.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'PanelMint не может отличить законную смену ключа от захвата — отсюда они выглядят одинаково. Прежде чем принять новый ключ, подтвердите его у автора по каналу, которому вы уже доверяете. После этого плагин будет обновлён, а новый ключ — запомнен.',
  ...
  'admin.plugins.security.trustBody':
    'Установка плагина похожа на установку любого стороннего приложения: добавляйте только код от авторов, которым доверяете, а при сомнениях сначала проверьте его самостоятельно. PanelMint не несёт ответственности за сторонние плагины.',
  ...
  'admin.plugins.newerNeedsTrek': 'Доступна v{version} — требуется PanelMint {range}',
  ...
  'admin.plugins.versionNeedsTrek': 'требуется PanelMint {range}',
  ...
  'admin.plugins.dep.trekIncompatible': 'Требуется PanelMint {range} — на этом сервере {host}',
  'admin.plugins.dep.trekUnknown': 'Не указано, какие версии PanelMint поддерживаются',
  ...
  'admin.plugins.rangeBypass.title': 'Вне поддерживаемых версий PanelMint',
  'admin.plugins.rangeBypass.noticeTitle': 'Установлен вне поддерживаемых версий PanelMint',
  ...
  'admin.plugins.dep.trekBypassed':
    'Вне своего диапазона PanelMint ({range}) — проверки версии отключены',
  'admin.plugins.dep.trekBypassedUnknown': 'Диапазон PanelMint не указан — проверки версии отключены',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки PanelMint под себя.',
  ...
  'admin.weather.description':
    'PanelMint использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.update.text': 'Доступна версия PanelMint {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'PanelMint будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText':
    'Ваш экземпляр PanelMint работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  'admin.update.nonDockerText':
    'Этот экземпляр PanelMint работает не в Docker. Чтобы обновиться до {version}, повторно запустите способ установки или обновления, который вы использовали, — например, в Proxmox Community Scripts выполните обновление из консоли LXC:',
