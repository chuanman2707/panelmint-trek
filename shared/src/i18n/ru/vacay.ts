...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями PanelMint',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя PanelMint',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя PanelMint для совместного календаря отпусков.',
  ...
  'vacay.shareCalendarHint':
    'Позвольте другому пользователю PanelMint видеть ваш календарь отпусков. Только просмотр — без объединения и редактирования.',
