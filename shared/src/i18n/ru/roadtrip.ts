...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.import.note': 'Остановки добавляются в выбранный день. PanelMint пересчитает маршрут.',
  ...
  'roadtrip.limit.rangeEmptyHint': 'Укажите запас хода или заполните поля, и PanelMint посчитает сам.',
