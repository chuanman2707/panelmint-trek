...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFile': 'Экспорт файла',
  'dayplan.exportFileTooltip': 'Скачать поездку файлом .panelmint.json',
  'dayplan.exportFileDone': 'Файл поездки скачан',
  'dayplan.exportFileError': 'Не удалось экспортировать файл поездки',
