...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bienvenue sur PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': "Destination de voyage pittoresque avec l'interface PanelMint",
  ...
  'system_notice.thank_you_support.title': "Merci d'utiliser PanelMint",
  'system_notice.thank_you_support.body':
    "Un petit mot pour te remercier d'avoir installé PanelMint — ça compte vraiment beaucoup pour moi.\n\nJe suis développeur en solo et je construis PanelMint sur mon temps libre. Au départ, c'était juste un petit outil pour mes propres voyages, et je suis honnêtement bluffé par le soutien et l'intérêt de la communauté depuis. PanelMint est fait avec beaucoup de cœur de mon côté — mais aussi grâce aux nombreux et formidables contributeurs externes qui ont aidé à lui donner forme.\n\n**PanelMint est open source et entièrement gratuit — et le restera pour toujours. Pas de formules payantes, pas d'abonnements, aucun piège. Promis.**\n\nSi PanelMint t'est utile et que tu souhaites soutenir son développement, un petit café m'aide sincèrement à continuer — sans aucune pression, mais chaque tasse fait avancer les nuits blanches.\n\nMerci d'être là.\n\n— Maurice",
  ...
  'system_notice.v3_thankyou.body':
    "Avant de continuer — je veux prendre un instant.\n\nPanelMint a commencé comme un projet perso que j'ai construit pour mes propres voyages. Je n'aurais jamais imaginé qu'il grandirait au point que 4 000 d'entre vous lui fassent confiance pour planifier vos aventures. Chaque étoile, chaque issue, chaque demande de fonctionnalité — je les lis toutes, et ce sont elles qui me font tenir pendant les nuits blanches entre un travail à temps plein et l'université.\n\nJe veux que vous sachiez : PanelMint sera toujours open source, toujours auto-hébergé, toujours à vous. Pas de tracking, pas d'abonnements, pas de conditions cachées. Juste un outil construit par quelqu'un qui aime voyager autant que vous.\n\nUn merci tout particulier à [jubnl](https://github.com/jubnl) — tu es devenu un collaborateur incroyable. Une grande partie de ce qui rend la 3.0 géniale porte ton empreinte. Merci d'avoir cru en ce projet quand il était encore brut.\n\nEt à chacun d'entre vous qui a signalé un bug, traduit une chaîne, partagé PanelMint avec un ami ou simplement l'a utilisé pour planifier un voyage — **merci**. Vous êtes la raison pour laquelle tout ceci existe.\n\nÀ de nombreuses autres aventures ensemble.\n\n— Maurice\n\n---\n\n[Rejoins la communauté sur Discord](https://discord.gg/7Q6M6jDwzf)\n\nSi PanelMint rend tes voyages meilleurs, un [petit café](https://ko-fi.com/mauriceboe) aide toujours à garder les lumières allumées.",
  ...
  'system_notice.release_notes.headline': 'Quatre choses que PanelMint fait désormais tout seul.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'L’alternative auto-hébergée à Google Timeline, désormais lisible depuis PanelMint. PanelMint lit, et ne fait que lire.',
  'system_notice.release_notes.footnote': 'Et une longue liste de changements plus discrets dans le reste de PanelMint.',
  'system_notice.release_notes.notes_label': 'Notes de version',
  'system_notice.release_notes.note_eyebrow': 'Un mot du mainteneur',
  'system_notice.release_notes.note_title': "C'est pour vous que je continue à construire PanelMint.",
  'system_notice.release_notes.note_body':
    "PanelMint est né comme un petit outil pour mes propres voyages, écrit après le travail parce que je voulais une meilleure façon de les préparer. Il n'a jamais vraiment cessé de grandir. Presque tout ce qui existe aujourd'hui a été construit tard le soir, le week-end, dans le train, à côté d'un travail à temps plein, et bien des soirs je me suis demandé en silence si quelqu'un, quelque part, l'ouvrirait un jour.",
  'system_notice.release_notes.promise_label': 'La promesse',
  'system_notice.release_notes.promise_lead': 'PanelMint reste gratuit, pour toujours.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint est gratuit et le restera toujours, mais les serveurs, les noms de domaine et toutes ces nuits blanches, eux, ne le sont pas.',
  'system_notice.release_notes.support_text':
    "Si PanelMint s'est fait une place dans tes voyages, offre-moi un café et aide la prochaine version à voir le jour.",
