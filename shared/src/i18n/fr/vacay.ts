...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': "Partagez votre plan de vacances avec d'autres utilisateurs PanelMint",
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': "E-mail de l'utilisateur PanelMint",
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur PanelMint à partager un calendrier de vacances combiné.',
  ...
  'vacay.shareCalendarHint':
    'Permettez à un autre utilisateur PanelMint de voir votre calendrier de vacances. Lecture seule — pas de fusion, pas de modification.',
