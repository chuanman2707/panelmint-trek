...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFileTooltip': 'Télécharger le voyage en fichier .panelmint.json',
  'dayplan.exportFileDone': 'Fichier du voyage téléchargé',
  'dayplan.exportFileError': 'Impossible d\'exporter le fichier du voyage',
