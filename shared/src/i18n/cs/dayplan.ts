...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFileTooltip': 'Stáhnout cestu jako soubor .panelmint.json',
  'dayplan.exportFileDone': 'Soubor cesty stažen',
  'dayplan.exportFileError': 'Soubor cesty se nepodařilo exportovat',
