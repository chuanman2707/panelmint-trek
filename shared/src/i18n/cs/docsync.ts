...
const docsync: TranslationStrings = {
  ...
  'docsync.confirmUnlink': 'Dokumenty zůstanou v PanelMintu i v úložišti. Zruší se jen jejich propojení.',
  ...
  'docsync.onConflict.trek_wins': 'Ponechat kopii z PanelMintu',
  'docsync.onConflict.provider_wins': 'Ponechat kopii z úložiště',
  'docsync.webhookHint':
    'Vložte tuto URL k poskytovateli, aby změny přicházely okamžitě. Bez toho se PanelMint ptá v pravidelných intervalech.',
  ...
  'docsync.hintBasePath': 'Kde PanelMint hledá složky cest. Výchozí je /TREK.',
  ...
  'docsync.state.local_deleted': 'Smazáno v PanelMintu',
  ...
  'docsync.conflict.keepTrek': 'Ponechat verzi z PanelMintu',
  ...
  'docsync.error.rate_limited': 'Poskytovatel omezuje počet požadavků. PanelMint to zkusí znovu později.',
  ...
  'docsync.empty.hintOwner':
    'Vyberte úložiště vlevo. PanelMint si vždy nechává vlastní kopii, takže se nic neztratí, ani když úložiště zmizí.',
  'docsync.empty.hintMember': 'Nastavuje to vlastník cesty. Dokumenty tak jako tak zůstávají v PanelMintu.',
  ...
  'docsync.connect.about.paperless': 'PanelMint ukládá tuto cestu pod vlastním štítkem a zbytku vašeho archivu se nedotkne.',
  'docsync.connect.about.papra': 'Vyberte organizaci, do které cesta patří. PanelMint ji v ní uloží pod vlastním štítkem.',
  'docsync.connect.about.nextcloud':
    'Použijte heslo aplikace, ne heslo k účtu: funguje i s dvoufaktorovým ověřením a dá se zrušit samostatně.',
  'docsync.connect.about.opencloud': 'PanelMint dostane pro tuto cestu vlastní prostor, oddělený od všeho ostatního.',
  ...
  'docsync.scope.intro': 'Synchronizuje se jen to, co je uvnitř. Zbytek vašeho úložiště zůstane mimo PanelMint.',
  ...
  'docsync.issues.remote_missing': 'V úložišti už není. Kopie v PanelMintu tu zůstává.',
