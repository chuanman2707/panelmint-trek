...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Vítejte v PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním PanelMint',
  ...
  'system_notice.thank_you_support.title': 'Děkuji, že používáte PanelMint',
  'system_notice.thank_you_support.body':
    'Rychlé poděkování za to, že jste si nainstalovali PanelMint — upřímně, znamená to pro mě hodně.\n\nJsem jediný vývojář a PanelMint tvořím ve svém volném čase. Začalo to jako malý nástroj jen pro mé vlastní cesty a od té doby mě podpora a zájem komunity naprosto dostávají. PanelMint dělám s velkým srdcem — ale také díky mnoha úžasným externím přispěvatelům, kteří ho pomohli utvářet.\n\n**PanelMint je open source a zcela zdarma — a tak to navždy zůstane. Žádné placené verze, žádná předplatná, žádné háčky. Slibuji.**\n\nPokud je pro vás PanelMint užitečný a chtěli byste podpořit jeho vývoj, malá káva mi opravdu pomáhá pokračovat ve tvoření — žádný tlak, ale každý šálek mi pomáhá přečkat pozdní noci.\n\nDěkuji, že jste tady.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'Čtyři věci, které PanelMint nyní zvládne sám.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Self-hosted odpověď na Google Timeline, teď čitelná přímo v PanelMint. PanelMint čte, a jen čte.',
  'system_notice.release_notes.footnote': 'A k tomu dlouhý seznam menších změn napříč zbytkem PanelMint.',
  'system_notice.release_notes.notes_label': 'Poznámky k vydání',
  'system_notice.release_notes.note_eyebrow': 'Slovo od autora',
  'system_notice.release_notes.note_title': 'Vy jste důvod, proč na PanelMint pořád pracuji.',
  'system_notice.release_notes.note_body':
    'PanelMint začal jako malý nástroj pro mé vlastní cesty, psaný po práci, protože jsem je chtěl plánovat lépe. Vlastně nikdy nepřestal růst. Skoro všechno, co používáte, vzniklo pozdě v noci, o víkendech, ve vlacích, vedle práce na plný úvazek, a bylo spoustu večerů, kdy jsem se potichu ptal, jestli ho tam venku vůbec někdy někdo otevře.',
  'system_notice.release_notes.promise_label': 'Slib',
  'system_notice.release_notes.promise_lead': 'PanelMint zůstane zdarma, navždy.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint je a vždycky bude zdarma, ale servery, domény a spousta pozdních nocí zdarma nejsou.',
  'system_notice.release_notes.support_text':
    'Pokud si PanelMint získal místo na vašich cestách, kupte mi kávu a pomozte, aby přišlo i další vydání.',
