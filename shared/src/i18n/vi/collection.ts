...
const collection: TranslationStrings = {
  ...
  'collections.file.errorNotACollection': 'Đây không phải tệp danh sách của PanelMint.',
  'collections.file.formatTrek': 'Danh sách PanelMint',
  'collections.file.formatTrekHint': 'Cho một PanelMint khác, kèm nhãn và trạng thái',
