...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_photos.body':
    '旅行プランナー内の写真は削除されましたが、写真データは安全です。PanelMintがImmichやSynologyのライブラリを変更することはありません。\n\n写真は現在日記アドオンにあります。日記は任意機能です。未有効の場合は、管理画面 → アドオンで有効にしてください。',
  ...
  'system_notice.v3_thankyou.body':
    '少しだけお時間をください。\n\nPanelMintは、自分の旅のために作った小さな個人プロジェクトでした。それが今では4,000人以上に使ってもらえるとは思ってもいませんでした。スターも、Issueも、機能要望も、すべて目を通しています。\n\nPanelMintはこれからもオープンソース、自分でホストでき、あなたのものです。トラッキングなし、サブスクなし。旅が好きな人が作ったツールです。\n\nhttps://github.com/jubnlにも感謝を。3.0の多くはあなたのおかげです。\n\nバグ報告、翻訳、共有、利用してくれたすべての方へ—本当にありがとうございます。\n\nこれからも一緒に旅を。\n\n— Maurice',
  ...
  'system_notice.thank_you_support.title': 'PanelMintを使ってくれてありがとう',
  'system_notice.thank_you_support.body':
    'PanelMintをインストールしてくれて、ちょっとお礼を言わせてください。本当に、心から嬉しいです。\n\n私は一人で開発をしていて、PanelMintは空いた時間に作っています。もともとは自分の旅のためだけの小さなツールでしたが、それ以来コミュニティから寄せられる応援や関心に、正直なところ圧倒されています。PanelMintは私自身がたくさんの思いを込めて作っていますが、それと同時に、形づくるのを手伝ってくれた多くの素晴らしい外部コントリビューターのおかげでもあります。\n\n**PanelMintはオープンソースで、完全に無料です。そしてこれからもずっと変わりません。有料プランも、サブスクリプションも、隠れた仕掛けも、一切ありません。約束します。**\n\nもしPanelMintがあなたの役に立っていて、開発を応援したいと思ってもらえたなら、ちょっとしたコーヒー一杯が、これからも作り続ける本当の支えになります。まったく無理はしないでください。でも一杯ごとに、夜なべの作業が続けられます。\n\nここにいてくれて、ありがとう。\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'PanelMintが自分でできるようになった4つのこと。',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Google Timelineのセルフホスト版とも言えるDawarichを、PanelMintの中で読めるようになりました。PanelMintは読み取るだけで、それ以上のことはしません。',
  'system_notice.release_notes.footnote': 'ほかにも、PanelMintのあちこちに細かな変更がたくさん入っています。',
  'system_notice.release_notes.notes_label': 'リリースノート',
  'system_notice.release_notes.note_eyebrow': '開発者より',
  'system_notice.release_notes.note_title': 'あなたがいるから、PanelMintを作り続けています。',
  'system_notice.release_notes.note_body':
    'PanelMintは、自分の旅のための小さなツールとして始まりました。もっといい計画の立て方が欲しくて、仕事のあとに書いたものです。それからずっと、大きくなり続けてきました。いま使っていただいている機能のほとんどは、本業のかたわら、深夜や週末、電車の中で作ったものです。こんなもの、誰かが開いてくれる日は来るのだろうか。そうひとりで考えた夜も、何度もありました。',
  'system_notice.release_notes.promise_label': '約束',
  'system_notice.release_notes.promise_lead': 'PanelMintは、ずっと無料です。',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMintは無料で、これからもずっと無料です。でも、サーバーやドメイン、数えきれない夜なべはタダではありません。',
  'system_notice.release_notes.support_text':
    'PanelMintがあなたの旅に欠かせないものになっていたら、コーヒーを一杯おごってください。次のリリースを届ける力になります。',
