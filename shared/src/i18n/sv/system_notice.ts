...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_thankyou.body':
    'Innan du går – vill jag ta en stund.\n\nPanelMint började som ett sidoprojekt som jag skapade för mina egna resor. Jag hade aldrig kunnat föreställa mig att det skulle växa till något som 4 000 av er nu litar på för att planera era äventyr. Varje stjärna, varje problem, varje önskemål om funktioner – jag läser dem alla, och de är det som håller mig igång under sena nätter mellan mitt heltidsjobb och universitetet.\n\nJag vill att ni ska veta: PanelMint kommer alltid att vara öppen källkod, alltid självhostat, alltid ert. Ingen spårning, inga prenumerationer, inga förbehåll. Bara ett verktyg skapat av någon som älskar att resa lika mycket som ni.\n\nEtt särskilt tack till [jubnl](https://github.com/jubnl) – du har blivit en fantastisk samarbetspartner. Så mycket av det som gör 3.0 så bra bär dina avtryck. Tack för att du trodde på det här projektet när det fortfarande var lite ojämnt i kanterna.\n\nOch till var och en av er som rapporterade ett fel, översatte en sträng, delade PanelMint med en vän eller helt enkelt använde det för att planera en resa – **tack**. Ni är anledningen till att det här finns.\n\nSkål för många fler äventyr tillsammans.\n\n— Maurice\n\n---\n\n[Gå med i communityn på Discord](https://discord.gg/7Q6M6jDwzf)\n\nOm PanelMint gör dina resor bättre, så håller en [liten kaffe](https://ko-fi.com/mauriceboe) alltid lamporna tända.',
  ...
  'system_notice.welcome_v1.title': 'Välkommen till PanelMint',
  ...
  'system_notice.welcome_v1.hero_alt': 'Ett naturskönt resmål med PanelMint planering UI-överlagring',
  ...
  'system_notice.thank_you_support.title': 'Tack för att du använder PanelMint',
  'system_notice.thank_you_support.body':
    'Ett snabbt tack för att du installerade PanelMint – det betyder verkligen mycket.\n\nJag är en ensam utvecklare och bygger PanelMint på min fritid. Det började som ett litet verktyg bara för mina egna resor, och jag är ärligt talat överväldigad av allt stöd och intresse från communityn sedan dess. PanelMint är skapat med mycket hjärta från min sida – men också tack vare de många fantastiska externa bidragsgivare som har hjälpt till att forma det.\n\n**PanelMint är öppen källkod och helt gratis – och kommer alltid att förbli så. Inga betalnivåer, inga prenumerationer, inga förbehåll. Jag lovar.**\n\nOm PanelMint är användbart för dig och du vill stödja utvecklingen, så hjälper en liten kaffe mig verkligen att fortsätta bygga – ingen press alls, men varje kopp håller de sena nätterna igång.\n\nTack för att du är här.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'Fyra saker PanelMint nu gör på egen hand.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Det självhostade svaret på Google Timeline, nu läsbart direkt i PanelMint. PanelMint läser, och bara läser.',
  'system_notice.release_notes.footnote': 'Dessutom en lång rad mindre ändringar i resten av PanelMint.',
  'system_notice.release_notes.notes_label': 'Versionsnyheter',
  'system_notice.release_notes.note_eyebrow': 'Ett ord från utvecklaren',
  'system_notice.release_notes.note_title': 'Du är anledningen till att jag fortsätter bygga PanelMint.',
  'system_notice.release_notes.note_body':
    'PanelMint började som ett litet verktyg för mina egna resor, skrivet efter jobbet för att jag ville ha ett bättre sätt att planera dem. Det har egentligen aldrig slutat växa. Nästan allt du använder byggdes sent på nätterna, på helger, på tåg, vid sidan av ett heltidsjobb, och många kvällar undrade jag tyst för mig själv om någon där ute någonsin skulle öppna det.',
  'system_notice.release_notes.promise_label': 'Löftet',
  'system_notice.release_notes.promise_lead': 'PanelMint förblir gratis, för alltid.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint är gratis och kommer alltid att vara det, men servrar, domäner och många sena nätter är det inte.',
  'system_notice.release_notes.support_text':
    'Om PanelMint har förtjänat en plats på dina resor, så bjud mig gärna på en kaffe och hjälp till att nästa utgåva blir av.',
