...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFileTooltip': 'Ladda ner resan som en .panelmint.json-fil',
  'dayplan.exportFileDone': 'Resfilen har laddats ner',
  'dayplan.exportFileError': 'Det gick inte att exportera resfilen',
