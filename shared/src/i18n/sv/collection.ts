...
const collection: TranslationStrings = {
  ...
  'collections.file.errorNotACollection': 'Det här är ingen PanelMint-listfil.',
  'collections.file.formatTrek': 'PanelMint-lista',
  'collections.file.formatTrekHint': 'För en annan PanelMint, med etiketter och status',
