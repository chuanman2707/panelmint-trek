...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} vill ha åtkomst till ditt PanelMint konto. Logga in först.',
  'oauth.authorize.loginButton': 'Logga in på PanelMint',
  'oauth.authorize.requestLabel': 'Begäran om behörighet',
  'oauth.authorize.requestDescription': 'Den här applikationen begär åtkomst till ditt PanelMint konto.',
