...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFile': '파일보내기',
  'dayplan.exportFileTooltip': '여행을 .panelmint.json 파일로 다운로드',
  'dayplan.exportFileDone': '여행 파일을 다운로드했습니다',
  'dayplan.exportFileError': '여행 파일을보낼 수 없습니다',
