...
const collection: TranslationStrings = {
  ...
  'collections.file.errorNotACollection': 'PanelMint 목록 파일이 아닙니다.',
  'collections.file.formatTrek': 'PanelMint 목록',
  'collections.file.formatTrekHint': '다른 PanelMint용, 라벨과 상태 포함',
