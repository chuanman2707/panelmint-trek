...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_thankyou.body':
    '떠나시기 전에 잠깐 시간을 내주세요.\n\nPanelMint은 제 자신의 여행을 위해 만든 사이드 프로젝트로 시작했습니다. 4,000명이 넘는 분들이 모험을 계획하는 데 신뢰해 주실 줄은 상상도 못 했습니다. 모든 별, 모든 이슈, 모든 기능 요청 — 저는 다 읽고, 그것들이 풀타임 직장과 대학 사이의 늦은 밤을 버티게 해줍니다.\n\n알아주셨으면 합니다: PanelMint은 항상 오픈 소스이고, 항상 자체 호스팅이며, 항상 여러분의 것입니다. 추적 없음, 구독 없음, 조건 없음. 그저 여러분만큼 여행을 사랑하는 누군가가 만든 도구입니다.\n\n[jubnl](https://github.com/jubnl)에게 특별한 감사를. 당신은 훌륭한 협력자가 되었습니다. 3.0을 훌륭하게 만든 많은 부분에 당신의 손길이 담겨 있습니다. 거칠던 초기에 이 프로젝트를 믿어줘서 고맙습니다.\n\n그리고 버그를 제출하고, 문자열을 번역하고, PanelMint을 친구에게 공유하거나, 단순히 여행 계획에 사용해 주신 모든 분들께 — **감사합니다**. 여러분이 바로 이것이 존재하는 이유입니다.\n\n함께하는 더 많은 모험을 위해.\n\n— Maurice\n\n---\n\n[Discord 커뮤니티에 참여하세요](https://discord.gg/7Q6M6jDwzf)\n\nPanelMint이 여행을 더 즐겁게 만들어 준다면, [커피 한 잔](https://ko-fi.com/mauriceboe)으로 불을 켜두는 데 도움이 됩니다.',
  ...
  'system_notice.welcome_v1.title': 'PanelMint에 오신 것을 환영합니다',
  'system_notice.welcome_v1.body':
    '올인원 여행 플래너. 일정을 만들고, 친구들과 여행을 공유하고, 온라인 또는 오프라인으로 체계적으로 유지하세요.',
  'system_notice.welcome_v1.cta_label': '여행 계획',
  'system_notice.welcome_v1.hero_alt': 'PanelMint 계획 UI 오버레이가 있는 아름다운 여행지',
  ...
  'system_notice.thank_you_support.title': 'PanelMint을 사용해 주셔서 감사합니다',
  'system_notice.thank_you_support.body':
    'PanelMint을 설치해 주셔서 감사하다는 짧은 인사를 전하고 싶습니다 — 정말 큰 힘이 됩니다.\n\n저는 1인 개발자이고, 여가 시간에 PanelMint을 만들고 있습니다. 처음에는 그저 제 여행을 위한 작은 도구로 시작했는데, 그 이후로 커뮤니티에서 보내주신 응원과 관심에 솔직히 놀라움을 감추지 못하고 있습니다. PanelMint은 제 온 마음을 담아 만들었지만 — 이 프로젝트를 함께 다듬어 주신 많은 멋진 외부 기여자분들 덕분이기도 합니다.\n\n**PanelMint은 오픈 소스이며 완전히 무료입니다 — 그리고 앞으로도 영원히 그럴 것입니다. 유료 등급도, 구독도, 숨겨진 조건도 없습니다. 약속드릴게요.**\n\nPanelMint이 도움이 되셨고 개발을 응원하고 싶으시다면, 작은 커피 한 잔이 제가 계속 만들어 나가는 데 정말 큰 힘이 됩니다 — 전혀 부담 갖지 마세요. 하지만 한 잔 한 잔이 늦은 밤을 버티게 해줍니다.\n\n함께해 주셔서 감사합니다.\n\n— Maurice',
  ...
  'system_notice.release_notes.headline': 'PanelMint가 이제 스스로 해내는 네 가지.',
  ...
  'system_notice.release_notes.feature_dawarich_body': 'Google Timeline의 자체 호스팅 대안인 Dawarich를 이제 PanelMint 안에서 읽을 수 있습니다. PanelMint은 읽기만, 오직 읽기만 합니다.',
  'system_notice.release_notes.footnote': '그 밖에도 PanelMint 곳곳에 작은 변경이 많이 담겨 있습니다.',
  'system_notice.release_notes.notes_label': '릴리스 노트',
  'system_notice.release_notes.note_eyebrow': '개발자의 한마디',
  'system_notice.release_notes.note_title': '여러분이 있어서 PanelMint을 계속 만듭니다.',
  'system_notice.release_notes.note_body':
    'PanelMint은 제 여행을 위한 작은 도구로 시작했습니다. 여행을 더 잘 계획하고 싶어서 퇴근 후에 짬을 내 만들었습니다. 그 뒤로 사실상 한 번도 자라기를 멈춘 적이 없습니다. 여러분이 쓰는 거의 모든 기능은 풀타임 직장을 다니면서 늦은 밤에, 주말에, 기차 안에서 만들었고, 과연 누가 이걸 열어보기나 할까 조용히 생각하던 저녁도 많았습니다.',
  'system_notice.release_notes.promise_label': '약속',
  'system_notice.release_notes.promise_lead': 'PanelMint은 영원히 무료입니다.',
  ...
  'system_notice.release_notes.support_lead':
    'PanelMint은 무료이고 앞으로도 그렇겠지만, 서버와 도메인, 수많은 늦은 밤은 무료가 아닙니다.',
  'system_notice.release_notes.support_text':
    'PanelMint이 여러분의 여행에 자리를 잡았다면, 커피 한 잔으로 다음 릴리스가 계속 나올 수 있게 도와주세요.',
