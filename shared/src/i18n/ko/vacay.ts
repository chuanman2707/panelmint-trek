...
const vacay: TranslationStrings = {
  ...
  'vacay.sharing': '공유',
  'vacay.sharingHint': '다른 PanelMint 사용자와 휴가 계획을 공유합니다',
  'vacay.owner': '소유자',
  'vacay.shareEmailPlaceholder': 'PanelMint 사용자 이메일',
  ...
  'vacay.inviteHint': '다른 PanelMint 사용자를 초대하여 통합 휴가 캘린더를 공유하세요.',
  ...
  'vacay.shareCalendarHint':
    '다른 PanelMint 사용자가 내 휴가 캘린더를 볼 수 있게 합니다. 보기 전용 — 퓨전이나 편집은 불가능합니다.',
