...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Μοιραστείτε το πλάνο διακοπών σας με άλλους χρήστες PanelMint',
  'vacay.owner': 'Κάτοχος',
  'vacay.shareEmailPlaceholder': 'Email χρήστη PanelMint',
  ...
  'vacay.inviteHint': 'Προσκαλέστε έναν άλλο χρήστη PanelMint για να μοιραστείτε ένα κοινό ημερολόγιο διακοπών.',
  ...
  'vacay.shareCalendarHint':
    'Επιτρέψτε σε έναν άλλο χρήστη PanelMint να βλέπει το ημερολόγιο διακοπών σας. Μόνο προβολή — χωρίς συγχώνευση, χωρίς επεξεργασία.',
