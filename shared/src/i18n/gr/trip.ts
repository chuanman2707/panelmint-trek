...
const trip: TranslationStrings = {
  ...
  'trip.invite.linkHint':
    'Όποιος έχει λογαριασμό PanelMint και ανοίξει αυτόν τον σύνδεσμο, εντάσσεται στο ταξίδι ως μέλος. Δημιουργήστε ξανά τον σύνδεσμο για να ακυρώσετε τον παλιό.',
