...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'Από πού προέρχονται τα δεδομένα τόπων. Το ευρετήριο του PanelMint δεν χρειάζεται κλειδί· οι δύο πάροχοι παρακάτω είναι προαιρετικοί.',
  'admin.trekApi.badgeDefault': 'Προτεινόμενη προεπιλογή',
  'admin.googleCaveat.badge': 'Δεν συνιστάται',
  'admin.googleCaveat.body':
    'Το PanelMint είναι ανοιχτού κώδικα και εδώ δεν είμαστε ουδέτεροι. Σε αυτή την κλίμακα, βαθμολογίες και φωτογραφίες συνηθισμένων καταστημάτων υπάρχουν μόνο στη Google, και αυτό είναι μονοπώλιο. Το πεδίο υπάρχει ελλείψει εναλλακτικής, όχι επειδή το συνιστούμε. Τότε κάθε αναζήτηση πηγαίνει στη Google.',
  'admin.trekApi.tagline':
    'Το δικό του ευρετήριο τόπων του PanelMint. Αναζήτηση χωρίς κλειδί Google, χωρίς όριο και χωρίς να μετράει κανείς τις αναζητήσεις σας.',
  ...
  'admin.placesProvider.subtitle':
    'Το δικό του ευρετήριο του PanelMint και το OpenStreetMap απαντούν σε κάθε αναζήτηση. Εδώ επιλέγεται ποιος άλλος ρωτιέται όταν δεν βρίσκουν τίποτα: το Αυτόματο προτιμά τη Google αν υπάρχει κλειδί, μετά το Amap.',
  'admin.placesProvider.auto': 'Αυτόματα',
  'admin.placesProvider.google': 'Google Places',
  'admin.placesProvider.amap': 'Amap (高德地图)',
  'admin.placesProvider.openstreetmap': 'OpenStreetMap',
  'admin.placesProvider.missingKey': 'Ο επιλεγμένος πάροχος δεν έχει ρυθμισμένο κλειδί API, οπότε στην αναζήτηση τόπων απαντούν μόνο το ευρετήριο του PanelMint και το OpenStreetMap.',
  ...
  'admin.plugins.requiresTrek': 'Απαιτεί PanelMint {version}+',
  ...
  'admin.plugins.perm.hook:search-provider':
    'Απάντηση σε αναζητήσεις τοποθεσιών από δικό του ευρετήριο, δίπλα στα αποτελέσματα του PanelMint',
  ...
  'admin.plugins.perm.geolocation:read':
    'Αίτημα της τρέχουσας τοποθεσίας σας όσο μία από τις προβολές του είναι ανοιχτή (το PanelMint τη διαβάζει με την άδεια τοποθεσίας αυτού του ιστότοπου, όχι με δική του άδεια του πρόσθετου)',
  ...
  'admin.plugins.reviewedMeaning':
    'Το "Ελεγμένο" σημαίνει ότι ένας συντηρητής του PanelMint σάρωσε αυτό το plugin για κακόβουλο λογισμικό σε κάθε έκδοση — όχι για την ποιότητα ή για το αν λειτουργεί. Δεν αποτελεί εγγύηση ότι ένα plugin είναι ακίνδυνο.',
  ...
  'admin.plugins.sig.missingBody':
    'Αυτό το plugin ήταν υπογεγραμμένο όταν το εγκαταστήσατε, αλλά η νέα έκδοση δεν περιλαμβάνει καμία υπογραφή. Το PanelMint δεν θα δεχτεί σιωπηλά αυτή την υποβάθμιση. Αυτό δεν μπορεί να παρακαμφθεί.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'Το PanelMint δεν μπορεί να ξεχωρίσει μια νόμιμη αλλαγή κλειδιού από μια κατάληψη — από εδώ φαίνονται πανομοιότυπες. Επιβεβαιώστε το νέο κλειδί με τον δημιουργό μέσω ενός καναλιού που ήδη εμπιστεύεστε, προτού το αποδεχτείτε. Μόλις το κάνετε, το plugin ενημερώνεται και το νέο κλειδί απομνημονεύεται.',
  ...
  'admin.plugins.security.trustBody':
    'Η εγκατάσταση ενός plugin είναι σαν την εγκατάσταση οποιασδήποτε εφαρμογής τρίτου: προσθέστε κώδικα μόνο από δημιουργούς που εμπιστεύεστε, και σε περίπτωση αμφιβολίας, ελέγξτε τον πρώτα μόνοι σας. Το PanelMint δεν αναλαμβάνει καμία ευθύνη για plugins τρίτων.',
  ...
  'admin.plugins.newerNeedsTrek': 'Διαθέσιμη η v{version} — απαιτεί PanelMint {range}',
  ...
  'admin.plugins.versionNeedsTrek': 'απαιτεί PanelMint {range}',
  ...
  'admin.plugins.dep.trekIncompatible': 'Απαιτεί PanelMint {range} — αυτός ο διακομιστής εκτελεί {host}',
  'admin.plugins.dep.trekUnknown': 'Δεν δηλώνει ποιες εκδόσεις PanelMint υποστηρίζει',
  ...
  'admin.plugins.rangeBypass.title': 'Εκτός των υποστηριζόμενων εκδόσεων PanelMint',
  'admin.plugins.rangeBypass.noticeTitle': 'Εγκαταστάθηκε εκτός των υποστηριζόμενων εκδόσεων PanelMint',
  ...
  'admin.plugins.dep.trekBypassed':
    'Εκτός του εύρους PanelMint του ({range}) — έλεγχοι έκδοσης απενεργοποιημένοι',
  'admin.plugins.dep.trekBypassedUnknown': 'Δεν δηλώνει εύρος PanelMint — έλεγχοι έκδοσης απενεργοποιημένοι',
  ...
  'admin.addons.subtitle':
    'Ενεργοποιήστε ή απενεργοποιήστε λειτουργίες για να εξατομικεύσετε την εμπειρία σας στο PanelMint.',
  ...
  'admin.weather.description':
    'Το PanelMint χρησιμοποιεί το Open-Meteo ως πηγή δεδομένων καιρού. Το Open-Meteo είναι μια δωρεάν, ανοιχτού κώδικα υπηρεσία καιρού — δεν απαιτείται κλειδί API.',
  ...
  'admin.update.text': 'Το PanelMint {version} είναι διαθέσιμο. Εκτελείτε το {current}.',
  ...
  'admin.update.confirmText':
    'Το PanelMint θα ενημερωθεί από {current} σε {version}. Ο server θα επανεκκινήσει αυτόματα στη συνέχεια.',
  ...
  'admin.update.dockerText':
    'Η εγκατάστασή σας PanelMint εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε τις ακόλουθες εντολές στον server σας:',
  'admin.update.nonDockerText':
    'Αυτή η εγκατάσταση PanelMint δεν εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε ξανά τη μέθοδο εγκατάστασης ή ενημέρωσης που χρησιμοποιήσατε — για παράδειγμα, στα Proxmox Community Scripts εκτελέστε την ενημέρωση από την κονσόλα LXC:',
