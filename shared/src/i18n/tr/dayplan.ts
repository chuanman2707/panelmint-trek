...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFile': 'Dosyayı dışa aktar',
  'dayplan.exportFileTooltip': 'Seyahati .panelmint.json dosyası olarak indir',
  'dayplan.exportFileDone': 'Seyahat dosyası indirildi',
  'dayplan.exportFileError': 'Seyahat dosyası dışa aktarılamadı',
