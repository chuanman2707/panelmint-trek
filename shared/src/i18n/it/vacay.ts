...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti PanelMint',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente PanelMint",
  ...
  'vacay.inviteHint': 'Invita un altro utente PanelMint a condividere un calendario ferie combinato.',
  ...
  'vacay.shareCalendarHint':
    'Consenti a un altro utente PanelMint di vedere il tuo calendario ferie. Sola visualizzazione — nessuna unione, nessuna modifica.',
