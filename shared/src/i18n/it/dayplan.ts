...
const dayplan: TranslationStrings = {
  ...
  'dayplan.exportFile': 'Esporta file',
  'dayplan.exportFileTooltip': 'Scarica il viaggio come file .panelmint.json',
  'dayplan.exportFileDone': 'File del viaggio scaricato',
  'dayplan.exportFileError': 'Impossibile esportare il file del viaggio',
