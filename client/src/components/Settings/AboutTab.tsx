...
export default function AboutTab({ appVersion }: Props): React.ReactElement {
  ...
  return (
    <Section title={t('settings.about')} icon={Info}>
      ...
      {/* Ko-fi, Buy Me a Coffee, Discord, and the issue/discussion links.
          The version badge above stays: AGPL §13 wants the source offered
          prominently to the people using it over a network. */}
