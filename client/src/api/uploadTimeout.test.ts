// FE-API-UPLOAD-002 to FE-API-UPLOAD-009
//
...
//
// Every multipart call goes through postMultipart(), so this suite pins ALL of the
// remaining ones. The hosted-only upload endpoints (avatar, plugin, journey, collab
// note, backup restore, booking import) are gone with the server.
//
