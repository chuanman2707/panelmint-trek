...
export default function MAdminGitHubPanel({ isPrerelease = false }: { isPrerelease?: boolean }) {
  ...
  const cards: LinkCard[] = [
    ...
    { href: 'https://github.com/chuanman2707/panelmint-trek/issues/new', color: '#ef4444', icon: <Bug size={18} className="text-[#ef4444]" />, title: t('settings.about.reportBug'), sub: t('settings.about.reportBugHint') },
    { href: 'https://github.com/chuanman2707/panelmint-trek/issues/new?labels=enhancement', color: '#f59e0b', icon: <Lightbulb size={18} className="text-[#f59e0b]" />, title: t('settings.about.featureRequest'), sub: t('settings.about.featureRequestHint') },
