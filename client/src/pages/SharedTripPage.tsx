  ...
  return (
    <div className="bg-surface-secondary" style={{ minHeight: '100vh', fontFamily: 'var(--font-system)' }}>
      ...
      >
        ...
        >
          <img src="/icons/icon-white.svg" alt="PanelMint" width="26" height="26" />
        </div>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '20px 16px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '40px 0 20px' }}>
          ...
          >
            <img src="/icons/icon.svg" alt="PanelMint" width="18" height="18" style={{ borderRadius: 4 }} />
            <span className="text-[#9ca3af]" style={{ fontSize: 'calc(11px * var(--fs-scale-caption, 1))' }}>
              {t('shared.sharedVia')} <strong className="text-[#6b7280]">PanelMint</strong>
            </span>
          </div>
          <div className="text-[#d1d5db]" style={{ marginTop: 8, fontSize: 'calc(10px * var(--fs-scale-caption, 1))' }}>
            Based on TREK by Maurice ·{' '}
            <a href="https://github.com/chuanman2707/panelmint-trek" className="text-[#9ca3af]" style={{ textDecoration: 'none' }}>
              Source code
            </a>
          </div>
        </div>
